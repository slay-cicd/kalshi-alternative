const siteConfig = {
  name: "Kalshi Alternative",
  tagline: "Kalshi Alternativen für Deutschland",
  description: "Kalshi Alternativen für Deutschland — Fundierte Analysen, Strategien und Tipps.",
  url: "https://kalshi-alternative.de",
  basePath: "",
  accentColor: "#7c3aed",
